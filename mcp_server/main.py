...
from models import Alt, BatchGetAmpUrlsRequest, BatchGetAmpUrlsResponse, FieldXgafv
...
app = MCPProxy(
    ...
    version='v1',
    servers=[{'url': 'https://acceleratedmobilepageurl.googleapis.com/'}],
)
...
def acceleratedmobilepageurl_amp_urls_batch_get(
    ...
    body: BatchGetAmpUrlsRequest = None,
):
